//
//  EventsWithSeparatorTableViewCell.swift
//  Tamo
//
...
class EventsWithSeparatorTableViewCell: UITableViewCell {
    ...
    func setUpCell(events: EventsCD) {
        ...
        lastEventsEndTimeLabel.text = events.prevEventsEndTm
        nextEventsStartTimeLabel.text = events.currentEventsStartTm
    }
